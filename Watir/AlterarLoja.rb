...
browser.screenshot.save 'Screenshot/Loja/Alterar/Lojas_ct06.png'

btn3 = browser.text_field(class: 'form-control input-sm')
btn3.exists?
btn3.set 'Araujo Store'
#btn3.set 'Active'
#btn3.set 'Burguer King'
#btn3.set 'Mc Donalds'
btn3.value
btn3.fire_event('onchange')
browser.screenshot.save 'Screenshot/Loja/Alterar/BuscaLoja_ct05.png'

browser.div.click
sleep 2

btn4 = browser.button(:class => "btn btn-default").when_present.click
browser.screenshot.save 'Screenshot/Loja/Alterar/LojaEdit_ct06.png'
sleep 2

btn5 = browser.text_field(id: 'edit_store_name')
btn5.exists?
#btn5.set 'Centauro'
#btn5.set ''
#btn5.set 'Xiaomi'
...
sleep 2
browser.screenshot.save 'Screenshot/Loja/Alterar/LojaEdit01_ct06.png'
sleep 2
browser.div.click
sleep 2
...
browser.screenshot.save 'Screenshot/Loja/Alterar/LojaAlterada_ct06.png'
