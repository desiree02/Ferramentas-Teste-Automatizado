    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createCategory', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal" name = "add_category">Add Category</button>
          <br /> <br />
        <?php endif; ?>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name ="save" id="savechanges">Save changes</button>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary" name ="save" id="salvar">Save changes</button>
        </div>
